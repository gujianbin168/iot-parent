...
public class MagicCodeDecoder extends ByteToMessageDecoder {
     ...
     */
    public MagicCodeDecoder(short magicNumber,
            int maxFrameLength,
            int lengthFieldOffset, int lengthFieldLength) {
        this(magicNumber,maxFrameLength, lengthFieldOffset, lengthFieldLength, 0, 0);
    }
...
//                            StringUtil.simpleClassName(getClass()) +
                           System.out.println(".decode() did not read anything but decoded a message.");
                           break;
                }
