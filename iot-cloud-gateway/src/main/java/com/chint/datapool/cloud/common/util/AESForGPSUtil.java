 ...
 * 
 */
public class AESForGPSUtil {

	/**
	 * 加密用的Key 可以用26个字母和数字组成 此处使用AES-128-CBC加密模式，key需要为16位。
	 */
	private static String sKey = "UalUV^u@F$2ZStxE";
	private String ivParameter = "lr60I@gpel#IIkSG";
	private static AESForGPSUtil instance = null;

	private AESForGPSUtil() {

	}

	public static AESForGPSUtil getInstance() {
		if (instance == null) {
			sKey = "*T#e8lYYYYMMDDHH";
			instance = new AESForGPSUtil();
		}
		return instance;
	}
